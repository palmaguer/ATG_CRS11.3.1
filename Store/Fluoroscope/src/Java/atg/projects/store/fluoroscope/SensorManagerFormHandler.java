 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Fluoroscope/src/atg/projects/store/fluoroscope/SensorManagerFormHandler.java#3 $$Change: 1536476 $ 
 * @updated $DateTime: 2018/04/13 08:11:14 $$Author: releng $
 */
public class SensorManagerFormHandler extends GenericFormHandler {
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Fluoroscope/src/atg/projects/store/fluoroscope/SensorManagerFormHandler.java#3 $$Change: 1536476 $";
