                ...
                <ul class="atg_store_storedCreditCardsActions">
                  ...
                  <li class="<crs:listClass count="1" size="2" selected="false"/>">
                    <dsp:a page="accountCardEdit.jsp" title="${editCardTitle}">
                      ...
                      <dsp:param name="cancelURL" value="${requestURL}"/>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Storefront/j2ee/store.war/myaccount/paymentInfo.jsp#1 $$Change: 1497274 $--%>
