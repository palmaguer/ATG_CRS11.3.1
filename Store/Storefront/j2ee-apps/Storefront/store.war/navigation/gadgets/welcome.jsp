...
<dsp:page>
  ...
  <div id="atg_store_userAccountNav">
    ...
    <c:set var="previewId" value="${param.atgPreviewId}" />
    <c:choose>
      <%-- The user is known --%>
        ...
        <ul>
          ...
          <li class="first atg_store_welcomeMessage">
            ...
            <c:choose>
              ...
              <c:otherwise>
                <dsp:a tabindex="-1" href="#" title="${notText}" iclass="atg_store_logoutLink atg_store_logoutDisabled">
                  <c:out value="${notText}"/>
                </dsp:a>
              </c:otherwise>
            </c:choose>
          ...
          <li class="last">
            <c:choose>
              ...
              <c:otherwise>
                <dsp:a tabindex="-1" href="#" title="${logoutTitle}" iclass="atg_store_logoutDisabled">
                  <c:out value="${logoutTitle}"/>
                </dsp:a>
              </c:otherwise>
            </c:choose>
...
<%-- @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Storefront/j2ee/store.war/navigation/gadgets/welcome.jsp#2 $$Change: 1510603 $ --%>
