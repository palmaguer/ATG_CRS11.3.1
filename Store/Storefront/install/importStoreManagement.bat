...
GOTO Loop
 ...
 :-store
   ...
   Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore.Versioned -repository /atg/store/stores/StoreContentRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/storecontent.xml -workspace initialStoreContent -comment initialStoreContent -user publishing
 ...
 :-i18n
   ...
   Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore.Versioned -repository /atg/store/stores/StoreContentRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/storecontent-i18n.xml -workspace initialStoreContent -comment initialStoreContent -user publishing
   Call %DYNAMO_HOME%\bin\startSQLRepository -m DCS-UI -m Store.EStore.Versioned -repository /atg/web/viewmapping/ViewMappingRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/EStore/Versioned/install/data/viewmapping.xml -workspace initialVwMapping -comment initialVwMapping -user publishing
