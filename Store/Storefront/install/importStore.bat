...
GOTO Loop
  ...
  :-store
    ...
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/store/stores/StoreContentRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/storecontent.xml
  ...
  :-i18n
    ...
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/userprofiling/ProfileAdapterRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/users.xml
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/commerce/locations/LocationRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/stores.xml
    Call %DYNAMO_HOME%\bin\startSQLRepository -m Store.EStore -repository /atg/store/stores/StoreContentRepository -import %DYNAMO_HOME%/../CommerceReferenceStore/Store/Storefront/data/storecontent-i18n.xml
