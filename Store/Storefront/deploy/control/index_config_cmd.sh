...
CLASSPATH=${CLASSPATH}:${ENDECA_ROOT}/lib/java/mail-1.4.jar
...
CLASSPATH=${CLASSPATH}:${ENDECA_ROOT}/lib/java/commons-lang3-3.7.jar

# Add CAS jars to the classpath
if [ -d "${CAS_ROOT}" ] ; then
  for i in ${CAS_ROOT}/lib/cas-dt/*.jar; do
