 ...
 * 
 * @author Paul Watson
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Endeca/Assembler/src/atg/projects/store/assembler/cartridge/handler/ProductListCategoryChildrenHandler.java#3 $$Change: 1536476 $
 * @updated $DateTime: 2018/04/13 08:11:14 $$Author: releng $
 */
public class ProductListCategoryChildrenHandler extends ActorInvokingCartridgeHandler {

  //----------------------------------------
  /** Class version string. */
  public static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Endeca/Assembler/src/atg/projects/store/assembler/cartridge/handler/ProductListCategoryChildrenHandler.java#3 $$Change: 1536476 $";
  ...
  public ContentItem process(ContentItem pCartridgeConfig) {
    ...
    if (shouldExecutePostProcessActor()) {
      super.process(categoryChildProductList);
   ...
   * @param pCartridgeConfig - The cartridge configuration for the CategoryChildProductList.
   * 
   * @param pCartridgeConfig - The actual cartridge used in this handler.
   * 
   */
