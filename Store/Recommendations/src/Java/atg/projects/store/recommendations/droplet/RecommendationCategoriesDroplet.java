 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Recommendations/src/atg/projects/store/recommendations/droplet/RecommendationCategoriesDroplet.java#3 $$Change: 1536476 $
 * @updated $DateTime: 2018/04/13 08:11:14 $$Author: releng $
 */
public class RecommendationCategoriesDroplet extends DynamoServlet{
  //-------------------------------------
  /** Class version string */
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Recommendations/src/atg/projects/store/recommendations/droplet/RecommendationCategoriesDroplet.java#3 $$Change: 1536476 $";
