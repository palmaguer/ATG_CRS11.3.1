 ...
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Recommendations/src/atg/projects/store/recommendations/processor/SetOrderProcessor.java#3 $Change: 630322 $
 * @updated $DateTime: 2018/04/13 08:11:14 $Author: ykostene $
 *
 */
public class SetOrderProcessor extends ADCEventPipelineProcessor{
  /** Class version string */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Recommendations/src/atg/projects/store/recommendations/processor/SetOrderProcessor.java#3 $Change: 630322 $";
