 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/multisite/StoreSitePropertiesManager.java#3 $$Change: 1536476 $
...
public class StoreSitePropertiesManager {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/multisite/StoreSitePropertiesManager.java#3 $$Change: 1536476 $";
  ...
  //-------------------------------------
  // Property: defaultPageContentPath
  //-------------------------------------  
  protected String mDefaultPageContentPath = "defaultPageContentPath";
  
  /**
   * @param pDefaultPageContentPath
   *   The defaultPageContentPath property name.
   */
  public void setDefaultPageContentPath(String pDefaultPageContentPath) {
    mDefaultPageContentPath = pDefaultPageContentPath;
  }
   ...
   *   The defaultPageContentPath property name.
   */
  public String getDefaultPageContentPath() {
    return mDefaultPageContentPath;
  }
