 ...
 *
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/droplet/PropertyValueCollection.java#2 $
 */
public class PropertyValueCollection extends DynamoServlet {

  /** Class version string. */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/droplet/PropertyValueCollection.java#2 $$Change: 1503965 $";
