 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/scenario/action/StoreFillRelatedItemsSlotActionConfiguration.java#3 $$Change: 1536476 $ 
...
public class StoreFillRelatedItemsSlotActionConfiguration extends FillRelatedItemsSlotActionConfiguration {
   ...
   * Class version
   */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/scenario/action/StoreFillRelatedItemsSlotActionConfiguration.java#3 $$Change: 1536476 $";
