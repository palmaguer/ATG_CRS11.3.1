 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/collections/filter/SkuInventoryFilter.java#3 $$Change: 1536476 $
...

{
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/collections/filter/SkuInventoryFilter.java#3 $$Change: 1536476 $";
 ...
 * @throws RepositoryException 
  ...
  protected boolean isSkuAvailable(RepositoryItem pSku, Object pParentItem, List pAvailableStates ) throws InventoryException, RepositoryException{
    ...
    int availabiltyStatus = ((StoreInventoryManagerInterface)getInventoryManager()).queryAvailabilityStatus(product, pSku.getRepositoryId());
