...
public class ItemRepositoryValidator extends GenericService implements CollectionObjectValidator {
   ...
   */
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/repository/filter/ItemRepositoryValidator.java#2 $$Change: 1503965 $";
