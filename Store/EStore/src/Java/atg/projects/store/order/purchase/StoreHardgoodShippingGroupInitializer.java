 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/order/purchase/StoreHardgoodShippingGroupInitializer.java#3 $$Change: 1536476 $
...
public class StoreHardgoodShippingGroupInitializer extends HardgoodShippingGroupInitializer {
  ...
  //-------------------------------------
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/order/purchase/StoreHardgoodShippingGroupInitializer.java#3 $$Change: 1536476 $";
