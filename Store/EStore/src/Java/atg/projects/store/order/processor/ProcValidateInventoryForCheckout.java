...
import atg.projects.store.inventory.StoreInventoryManagerInterface;
 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/order/processor/ProcValidateInventoryForCheckout.java#3 $$Change: 1536476 $
...
public class ProcValidateInventoryForCheckout extends ApplicationLoggingImpl implements PipelineProcessor {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/src/atg/projects/store/order/processor/ProcValidateInventoryForCheckout.java#3 $$Change: 1536476 $";
  ...
  protected boolean itemIsAvailable(CommerceItem pItem, InventoryManager pManager) {
    ...
    if (pManager instanceof StoreInventoryManagerInterface) {
      
      StoreInventoryManagerInterface storeInvManager = (StoreInventoryManagerInterface) pManager;
