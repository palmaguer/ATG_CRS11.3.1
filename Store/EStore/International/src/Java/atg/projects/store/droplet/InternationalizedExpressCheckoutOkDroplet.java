 ...
 * 
 * @author ATG
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/International/src/atg/projects/store/droplet/InternationalizedExpressCheckoutOkDroplet.java#3 $$Change: 1536476 $
...
public class InternationalizedExpressCheckoutOkDroplet extends ExpressCheckoutOkDroplet {
  ...
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/International/src/atg/projects/store/droplet/InternationalizedExpressCheckoutOkDroplet.java#3 $$Change: 1536476 $";
