 ...
 * @version $Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/International/Versioned/src/atg/web/repository/InternationalStoreNameChangingCloneHelper.java#3 $$Change: 1536476 $
...
public class InternationalStoreNameChangingCloneHelper extends NameChangingCloneHelper {
  ...
  // CONSTANTS
  //-------------------------------------
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/EStore/International/Versioned/src/atg/web/repository/InternationalStoreNameChangingCloneHelper.java#3 $$Change: 1536476 $";
