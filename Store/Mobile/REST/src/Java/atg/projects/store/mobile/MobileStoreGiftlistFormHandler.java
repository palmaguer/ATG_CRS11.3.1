 ...
 * @author ATG
 * @version $Id: //hosting-blueprint/MobileCommerce/version/11.3.1/server/MobileCommerce/src/atg/projects/store/mobile/MobileStoreGiftlistFormHandler.java#3 $
 * @updated $DateTime: 2018/04/13 09:41:19 $$Author: releng $
 */
public class MobileStoreGiftlistFormHandler extends StoreGiftlistFormHandler
{
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/MobileCommerce/version/11.3.1/server/MobileCommerce/src/atg/projects/store/mobile/MobileStoreGiftlistFormHandler.java#3 $$Change: 1536491 $";
