...
public class ActorInvokerPropertyCustomizer implements PropertyCustomizer {
  ...
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Mobile/src/atg/service/filter/bean/ActorInvokerPropertyCustomizer.java#2 $$Change: 1503965 $";
  ...
  public Object getPropertyValue(Object pTargetObject, String pPropertyName, Map<String,String> pAttributes) throws BeanFilterException {
    ...
    if (propertyParameterName != null) {
      Object object;
      try {
        object = DynamicBeans.getSubPropertyValue(pTargetObject, pPropertyName);
