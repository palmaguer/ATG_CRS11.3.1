...
public class StoreAnnouncementsHandler extends NavigationCartridgeHandler<ContentItem, StoreAnnouncementsContentItem> {
  ...
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/B2CBlueprint/version/11.3.1/Mobile/DCS-CSR/Endeca/src/atg/projects/store/assembler/cartridge/handler/StoreAnnouncementsHandler.java#2 $$Change: 1503965 $";
