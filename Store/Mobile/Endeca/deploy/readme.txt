...
deployment. This instruction also assumes you've already deployed full CRS application to Endeca, using
...
(<Endeca_ToolsAndFrameworks_HOME> is the Endeca "ToolsAndFrameworks" module root)
  ...
  2. Press "n" on "Install base deployment?"
     (you don't need the base deployment as you've already done it while deploying the full CRS).
